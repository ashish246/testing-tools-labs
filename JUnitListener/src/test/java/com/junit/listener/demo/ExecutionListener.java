...
/**
 * This listener will extend the RunListener class provided by Junit. You are
 * free to override any number of methods including no method at all.
 * 
...
public class ExecutionListener extends RunListener {
	...
	public void testRunFinished(Result result) throws java.lang.Exception {
		System.out.println("Number of testcases executed : "
				+ result.getRunCount());
	}
